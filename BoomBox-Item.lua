   ...
   Callback = function(Value)
       ...
       if Value then
           local success, errorMessage = pcall(function()
               ...
               -- ==========================================
               -- [NUEVO]: APERTURA DE UI SOLO AL TOCAR LA RADIO
               -- ==========================================
               local mouse = player:GetMouse()
               clonedTool.Activated:Connect(function()
                   -- Solo intercala la visibilidad del menú si el objeto clickeado es parte de la herramienta
                   if customUI and mouse.Target and mouse.Target:IsDescendantOf(clonedTool) then
               ...
               Rayfield:Notify({
                   ...
                   Content = "Clicking the radio directly now toggles the menu.",
                   Duration = 4,
               })
           end)
