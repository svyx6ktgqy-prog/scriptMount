   ...
   Callback = function(Value)
       ...
       if Value then
           local success, errorMessage = pcall(function()
               ...
               -- ==========================================
               -- [CORRECCIÓN DE POSTURA]: GANGSTER POSING PERFECTO
               -- ==========================================
               -- En lugar de forzarlo al lado izquierdo, lo subimos por el brazo derecho 
               -- hasta el hombro (Y = 1.7), lo acercamos al cuello (X = -0.7) 
               -- y lo inclinamos ligeramente (15 grados) para que descanse con naturalidad.
               
               clonedTool.Grip = CFrame.new(-0.7, 1.7, 0) * CFrame.Angles(math.rad(0), math.rad(-90), math.rad(15))
               
               -- NOTA DE CALIBRACIÓN MESH: 
               -- Si al equiparlo notas que los altavoces miran hacia atrás en lugar de hacia adelante, 
               -- cambia el "math.rad(-90)" por "math.rad(90)".
