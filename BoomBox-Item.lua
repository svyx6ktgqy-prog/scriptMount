   ...
   Callback = function(Value)
       ...
       if Value then
           local success, errorMessage = pcall(function()
               ...
               -- ==========================================
               -- Welds all parts to the Handle and makes them massless.
               -- This prevents invisible pieces from falling into the void and destroying your character/inventory.
               for _, part in pairs(clonedTool:GetDescendants()) do
                   if part:IsA("BasePart") then
                       part.Anchored = false
                       part.CanCollide = false 
                       part.Massless = true -- Prevents the radio's weight from altering your movement
               ...
               -- ==========================================
               -- Y = -0.8 perfectly elevates the radio into the palm of the hand. 
               -- The 15 degrees on Z gives it that natural gangster grip tilt.
               ...
               frame.Size = UDim2.new(0, 250, 0, 170) -- Increased height to fit new buttons
               ...
               -- ROW 2: Previous & Next (Playlist controls)
               ...
               -- Removed StarterGear injection to prevent duplicates breaking the hotbar
               ...
               Rayfield:Notify({
                   ...
                   Content = "Posture corrected & Playlist System loaded.",
                   Duration = 4,
               })
           end)
