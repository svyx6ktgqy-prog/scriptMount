...
SearchContainer.Size = UDim2.new(0.38, 0, 0, 36)
SearchContainer.Position = UDim2.new(0, 10, 0.5, -18)
...
KittySearchBtn.Size = UDim2.new(0, 65, 0, 36)
KittySearchBtn.Position = UDim2.new(0.40, 0, 0.5, -18)
...
-- BOTONES NAVEGACIÓN PAGINADA (SIGUIENTE / ATRÁS / INDICADOR PÁGINA)
local PrevBtn = Instance.new("TextButton")
PrevBtn.Size = UDim2.new(0, 32, 0, 36)
PrevBtn.Position = UDim2.new(0.53, 0, 0.5, -18)
PrevBtn.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
PrevBtn.Text = "◄"
PrevBtn.Font = Enum.Font.GothamBold
PrevBtn.TextSize = 13
PrevBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
PrevBtn.Parent = KittyTop
local PrevCorner = Instance.new("UICorner"); PrevCorner.CornerRadius = UDim.new(0, 8); PrevCorner.Parent = PrevBtn

local PageLabel = Instance.new("TextLabel")
PageLabel.Size = UDim2.new(0, 60, 0, 36)
PageLabel.Position = UDim2.new(0.60, 0, 0.5, -18)
PageLabel.BackgroundTransparency = 1
PageLabel.Text = "Pág 1"
PageLabel.Font = Enum.Font.GothamBold
PageLabel.TextSize = 12
PageLabel.TextColor3 = Color3.fromRGB(255, 20, 147)
PageLabel.Parent = KittyTop

local NextBtn = Instance.new("TextButton")
NextBtn.Size = UDim2.new(0, 32, 0, 36)
NextBtn.Position = UDim2.new(0.72, 0, 0.5, -18)
NextBtn.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
NextBtn.Text = "►"
NextBtn.Font = Enum.Font.GothamBold
NextBtn.TextSize = 13
NextBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
NextBtn.Parent = KittyTop
local NextCorner = Instance.new("UICorner"); NextCorner.CornerRadius = UDim.new(0, 8); NextCorner.Parent = NextBtn
...
local function PerformKittySearch(resetPage)
    ...
    if PageLabel then
        PageLabel.Text = "Pág " .. tostring(KittyCurrentPage)
    end
    ...
    task.spawn(function()
        local currentCursor = KittyCursors[KittyCurrentPage] or ""
        local cursorParam = currentCursor ~= "" and ("&cursor=" .. HttpService:UrlEncode(currentCursor)) or ""
        ...
        if success and response then
            ...
            if decoded and decoded.data then
                KittyNextCursor = decoded.nextPageCursor or nil
                if KittyNextCursor and KittyNextCursor ~= "" then
                    KittyCursors[KittyCurrentPage + 1] = KittyNextCursor
                end
...
for i, catData in ipairs(CategoriesEnglish) do
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        KittyCursors = { [1] = "" }
        KittyNextCursor = nil
        if PageLabel then PageLabel.Text = "Pág 1" end
        ...
        if KittySearch.Text ~= "" then
            PerformKittySearch(true)
        end
    end)
end

KittySearch.FocusLost:Connect(function(enterPressed) if enterPressed then PerformKittySearch(true) end end)
KittySearchBtn.MouseButton1Click:Connect(function() PerformKittySearch(true) end)

-- CONEXIÓN NAVEGACIÓN PAGINADA
