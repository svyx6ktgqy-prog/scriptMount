-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (FIX ADHERENCIA MILIMÉTRICA)
...
-- ==========================================================
-- 3. CEREBRO: FIX ROPA 3D + ADHERENCIA PERFECTA Y ESCALADO
-- ==========================================================
local function UniversalEquip(assetId, isReequipping)
    ...
    local success, err = pcall(function()
        ...
        local function ProcessItem(item)
            ...
            -- =========================================================
            -- ACCESORIOS Y ROPA 3D: ADHERENCIA NATIVA (FIX COLLARES Y PULSERAS)
            -- =========================================================
            if item:IsA("Accessory") then
                ...
                if handle then
                    ...
                    -- Limpiar uniones pre-existentes que causen el bug del espacio vacío
                    for _, v in ipairs(handle:GetChildren()) do
                        if v:IsA("Weld") or v:IsA("JointInstance") then 
                            v:Destroy() 
                        end
                    end
                ...
                -- Aplicar el motor nativo de Roblox para respetar offsets y evitar que los items floten
