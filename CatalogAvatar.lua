-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (UNIFICADO v15.0 DEFINITIVO)
-- Fix UI + Categorías Completas + Anclaje C0/C1 + Fallback
-- ==========================================================
...
-- ==========================================================
-- 3. CEREBRO V15: SOLDADURA MATEMÁTICA Y ROPA 3D/2D
-- ==========================================================
        ...
        local function ProcessItem(item)
            ...
            if item:IsA("Accessory") then
                ...
                if handle then
                    ...
                    -- A. Fix de Layered Clothing (Ropa 3D: Jackets, Sweaters, Pants 3D, Shoes)
            ...
            -- E. Fix para Caras y Maquillaje (Makeup/Faces)
            ...
            -- G. Bundles y Folders (Paquetes Completos)
...
ImagePreview.MouseButton1Click:Connect(function()
    ...
    if idNum and idNum > 0 then
        pcall(function()
            if CurrentData.ItemType == "Bundle" then MarketplaceService:PromptBundlePurchase(LocalPlayer, idNum)
            else MarketplaceService:PromptPurchase(LocalPlayer, idNum) end
        end)
    end
end)
...
-- ==========================================
-- DICCIONARIO ACTUALIZADO (Ropa 3D, Caras, etc.)
-- ==========================================
...
for i, catData in ipairs(CategoriesEnglish) do
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        -- Agrega la subcategoría visual al buscador para mejorar los resultados nativos
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v15.0",
