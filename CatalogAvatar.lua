...
-- Fix UI + Scroll Categories + Native Purchase + Equipamiento v9.0 FIX
-- ==========================================================
...
-- ==========================================================
-- SISTEMA DE EQUIPAMIENTO MEJORADO (Lógica exitosa de la v9.0)
-- ==========================================================
local function UniversalEquip(assetId)
    task.spawn(function()
        ...
        local success, err = pcall(function()
            -- Método confiable que adhiere texturas al pecho y accesorios a sus nodos
            ...
            for _, item in ipairs(objects) do
                ...
                if item:IsA("Accessory") then
                    -- AddAccessory lee los Attachments internos (Ej: BackAttachment para alas, HatAttachment para gorros)
                    -- y los coloca de forma nativa y perfecta en el cuerpo.
                    Hum:AddAccessory(item:Clone())

                elseif item:IsA("Shirt") or item:IsA("Pants") or item:IsA("ShirtGraphic") then
                    -- ShirtGraphic = T-Shirts/Texturas. Destruye el anterior para que no se encimen.
                ...
                elseif item:IsA("Decal") then
                    -- Caras personalizadas a la cabeza
        ...
        if not success then
            warn("Fallo al aplicar el item: " .. tostring(err))
        end
    end)
end
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Motor Unificado v9.5 FIX...",
   LoadingSubtitle = "Accesorios y Texturas Nativas Reparadas",
