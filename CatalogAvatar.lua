-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v20 DEFINITIVA)
-- Fix Ropa 3D (Anclaje Permanente) + Animaciones/Emotes en Vivo + Tools
-- ==========================================================
...
-- ==========================================================
-- 1. BUCLE ANTI-INVISIBILIDAD Y RENDER
-- ==========================================================
...
-- ==========================================================
-- 2. CEREBRO V20: FIX ROPA 3D + ANIMACIONES/EMOTES + TOOLS
-- ==========================================================
local function UniversalEquip(assetId, isReequipping)
    ...
    local success, err = pcall(function()
        ...
        -- Fallback si GetObjects regresa una lista vacía para Animaciones u Emotes
        if #objects == 0 then
        ...
        local function ProcessItem(item)
            ...
            -- SOPORTE ACCESORIOS Y ROPA 3D (Layered Clothing: Chaquetas, Pantalones, etc.)
            if item:IsA("Accessory") then
                ...
                if handle then
                    -- Configuración crítica de físicas para evitar que caigan o se desanclen
                    handle.Transparency = 0
                    handle.Anchored = false
                    handle.CanCollide = false
                    handle.Massless = true

                    -- Búsqueda de Attachment de destino en el cuerpo
                    ...
                    if accAttach then
                        ...
                        -- Fallback de anclaje directo si carece de Attachment explícito
            ...
            -- SOPORTE PARA PERSONAJES COMPLETOS (Extremidades R15)
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v20",
   LoadingTitle = "Actualizando Soporte Ropa 3D & Animaciones...",
