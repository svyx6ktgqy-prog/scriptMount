-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v22 DEFINITIVA)
...
-- ==========================================================
-- 3. CEREBRO V22: FIX COLLAR AL PECHO + ROPA 3D + ANIMACIONES
-- ==========================================================
                ...
                if handle then
                    ...
                    if accAttach then
                        ...
                        if targetAttach then
                            ...
                            -- POSICIONAMIENTO DIRECTO EN EL PECHO
                            ...
                            if string.find(attNameLower, "neck") or string.find(itemNameLower, "collar") or string.find(itemNameLower, "neck") or string.find(itemNameLower, "chain") or string.find(itemNameLower, "cadena") or string.find(itemNameLower, "pendant") then
                                offsetCFrame = CFrame.new(0, -0.65, 0.05)
                                
                                local mesh = handle:FindFirstChildWhichIsA("SpecialMesh")
                                if mesh then
                                    mesh.Scale = mesh.Scale * Vector3.new(1.15, 1.15, 1.15)
                        ...
                        local itemNameLower = string.lower(item.Name)
                        local bodyTarget = Char:FindFirstChild("UpperTorso") or Char:FindFirstChild("Torso") or Char.PrimaryPart
