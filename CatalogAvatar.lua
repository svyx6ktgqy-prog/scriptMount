-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.2 ACTUALIZADA)
-- Anti-Congelamiento + CHARACTERS.json + Viewport 3D en Tiempo Real
-- ==========================================================
...
CharMenu.Size = UDim2.new(0, 380, 0, 360)
...
CharMenuConstraint.MaxSize = Vector2.new(380, 360)
CharMenuConstraint.MinSize = Vector2.new(380, 360)
...
CharScroll.Size = UDim2.new(0, 350, 0, 265)
...
local function RefreshSavedCharactersGrid()
    ...
    for charName, itemIds in pairs(data) do
        ...
        -- VISTA PREVIA 3D EN TIEMPO REAL (Con Ropa y Accesorios Personalizados Equipados)
        ...
        if char then
            ...
            for _, sub in ipairs(charClone:GetDescendants()) do
                if sub:IsA("Script") or sub:IsA("LocalScript") or sub:IsA("Animator") then
                    sub:Destroy()
            ...
            local primary = charClone:FindFirstChild("HumanoidRootPart") or charClone:FindFirstChild("UpperTorso") or charClone:FindFirstChild("Torso") or charClone.PrimaryPart
            if primary then
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v23.2",
   LoadingTitle = "Actualizando Soporte Viewport 3D & Fixed Constraints...",
