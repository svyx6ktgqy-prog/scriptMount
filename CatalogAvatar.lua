-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.1 ACTUALIZADA)
...
CharMenu.ClipsDescendants = true -- Control de desbordamiento
...
local function RefreshSavedCharactersGrid()
    ...
    for charName, itemIds in pairs(data) do
        ...
        -- Imagen de Cuerpo Completo con Ropa e Ítems Actuales del Avatar
        local PreviewImg = Instance.new("ImageLabel")
        PreviewImg.Size = UDim2.new(1, -10, 0, 75)
        PreviewImg.Position = UDim2.new(0, 5, 0, 5)
        PreviewImg.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
        PreviewImg.Image = "rbxthumb://type=Avatar&id=" .. tostring(LocalPlayer.UserId) .. "&w=150&h=150"
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v23.1",
...
Panel:CreateToggle({
   ...
   Callback = function(Value)
       ...
       if Value then
           KittyMain.Visible = true
           FloatingBtn.Visible = false
           FloatingBtn.Position = DEFAULT_FLOATING_POS -- Restaurar posición original al activar
           ...
           FloatingBtn.Visible = false
           FloatingBtn.Position = DEFAULT_FLOATING_POS -- Restaurar posición original al desactivar
           EqPanel.Visible = false
           EditPanel.Visible = false
           CharMenu.Visible = false
