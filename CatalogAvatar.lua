-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v22 ACTUALIZADA + ROTACIÓN Y OFFSET Z)
-- Animaciones + Fix Ropa 3D + Auto-Ocultar Piernas + ESCALADO/OFFSET/JOYSTICK
-- ==========================================================
...
-- ==========================================================
-- SISTEMA DE EDICIÓN DE ÍTEMS EN TIEMPO REAL (OFFSET + JOYSTICK ROTACIÓN)
-- ==========================================================
local EditPanel = Instance.new("Frame")
EditPanel.Size = UDim2.new(0, 340, 0, 370)
...
-- Controles de Posición Horizontal (Ejes X / Z)
...
local ResetScaleSlider = CreateSlider("Escala (Tamaño)", 105, 0.1, 3, 1, function(val)
    EditScale = val
    ApplyTransformations()
end)

local ResetYSlider = CreateSlider("Posición (Arriba / Abajo)", 155, -3, 3, 0, function(val)
    EditOffsetY = val
    ApplyTransformations()
end)

-- Joystick de Rotación Libre 360°
local JoyLabel = Instance.new("TextLabel")
JoyLabel.Size = UDim2.new(1, 0, 0, 20)
JoyLabel.Position = UDim2.new(0, 0, 0, 180)
...
JoyBase.Size = UDim2.new(0, 90, 0, 90)
JoyBase.Position = UDim2.new(0.5, -45, 0, 210)
...
JoyKnob.Size = UDim2.new(0, 30, 0, 30)
...
UserInputService.InputChanged:Connect(function(input)
    if joyDragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
        ...
        JoyKnob.Position = UDim2.new(0.5, clampedDelta.X - 15, 0.5, clampedDelta.Y - 15)
