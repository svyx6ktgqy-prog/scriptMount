-- ==========================================================
-- MOTOR QUIRÚRGICO V13.0 DEFINITIVO (KITTY UI + SUPER ULTRA ENGINE)
-- 100% Equipamiento, Fix Anclaje 3D, Anti-Crash & Fallbacks
-- ==========================================================
...
-- ==========================================================
-- 1. SOLUCIÓN EXTREMA: GENERADOR QUIRÚRGICO (FALLBACK)
-- ==========================================================
...
-- ==========================================================
-- 3. CEREBRO DE EQUIPAMIENTO SUPER ULTRA (100% CATEGORÍAS)
-- ==========================================================
local function UniversalEquip(assetId)
    ...
    if not success then
        ...
        if Backpack then
            ...
            NotifyUser("⚠️ Contingencia Activada", "Se ha inyectado el equipo de reemplazo de precisión en tu inventario.")
        end
    end
end
        ...
        if decoded and decoded.data then
            for _, item in ipairs(decoded.data) do
                ...
                ClickBtn.MouseButton1Click:Connect(function()
                    ...
                    -- Llamamos a la nueva función de equipamiento universal
...
-- ==========================================================
-- 7. INTERFAZ RAYFIELD V13.0 UNIFICADA
-- ==========================================================
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico V13.0",
   LoadingTitle = "Cargando Motor Super Ultra...",
   LoadingSubtitle = "Anclaje 100% | Fallback Anti-Corrupción",
...
Panel:CreateButton({
   Name = "⚡ Equipar/Probar con Motor Super Ultra",
   Callback = function()
       local assetId = tonumber(CurrentData.Id)
       ...
       -- Llama a nuestro super motor unificado
