...
-- FIX ROPA 3D (PANTALONES/CAMISAS) ADAPTABLES AL CUERPO
-- ==========================================================
...
local function UniversalEquip(assetId, isReequipping)
    ...
    local success, err = pcall(function()
        ...
        local function ProcessItem(item)
            ...
            -- =========================================================
            -- SOPORTE ACCESORIOS Y ROPA 3D (WrapLayer) FIX DEFINITIVO
            -- =========================================================
            if item:IsA("Accessory") then
                ...
                if handle then
                    ...
                    if accAttach then
                        ...
                        if targetAttach then
                            ...
                            weld.Name = "AccessoryWeld" -- [EL SECRETO: ACTIVADOR DEL MOTOR DE FÍSICAS 3D]
                    ...
                    -- EL EMPUJÓN AL WRAPLAYER: Obliga a Roblox a adaptar los pantalones a las piernas localmente
                ...
                -- Soldamos manualmente, así que insertamos al personaje directo SIN AddAccessory para no generar conflictos
