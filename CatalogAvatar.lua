-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.9 FIX INPUT & LAYERS)
...
-- FIX 1: NameInput Alineación limpia sin saltos de padding
...
-- FIX 3: Prioridad de orden superior para estar siempre frente al visualizador
...
-- FIX 2: Recorte interno de la barra dentro del marco redondeado
...
SidebarCorner.Parent = KittySidebar
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v23.9",
