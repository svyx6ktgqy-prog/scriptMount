...
AddHoverEffect(SaveCharBtn, Color3.fromRGB(50, 205, 50), Color3.fromRGB(70, 225, 70))
...
CharGrid.SortOrder = Enum.SortOrder.LayoutOrder
...
local function RefreshSavedCharactersGrid()
    ...
    -- SISTEMA DE ORDENAMIENTO (Mantiene la primera posición consistente)
    local sortedNames = {}
    for charName in pairs(data) do
        table.insert(sortedNames, charName)
    end
    table.sort(sortedNames)

    for _, charName in ipairs(sortedNames) do
        local itemIds = data[charName]
        ...
        -- Contorno sutil para la tarjeta
        ...
        -- CONSTRUCCIÓN DE MINIATURA UNIVERSAL
        task.spawn(function()
        ...
        AddHoverEffect(LoadBtn, Color3.fromRGB(255, 105, 180), Color3.fromRGB(255, 140, 200))
        ...
        AddHoverEffect(DelBtn, Color3.fromRGB(255, 50, 50), Color3.fromRGB(255, 90, 90))
