-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (UNIFICADO v9.2 + KITTY MENU)
-- Responsivo (PC/Móvil) + Buscador Elegante + Compra Directa
-- ==========================================================
...
-- ==========================================================
-- SISTEMA DE VISUALIZADOR HUD (BOTÓN DE COMPRA)
-- ==========================================================
...
-- ==========================================================
-- SISTEMA KITTY CATALOG UI (RESPONSIVO Y CENTRADO)
-- ==========================================================
...
-- Fondo principal: Adaptable con límites
local KittyMain = Instance.new("Frame")
KittyMain.Size = UDim2.new(0.95, 0, 0.9, 0) -- 95% del ancho, 90% del alto (Móvil)
KittyMain.Position = UDim2.new(0.5, 0, 0.5, 0) -- Exactamente en el centro
KittyMain.AnchorPoint = Vector2.new(0.5, 0.5) -- Punto de anclaje central
...
-- Limita el tamaño en PC para que no se vea gigante
...
-- Topbar (Buscador): Toma el 75% del ancho derecho
...
KittySearch.Size = UDim2.new(0.7, -10, 0, 40)
KittySearch.Position = UDim2.new(0, 10, 0.5, -20)
...
SearchPadding.PaddingLeft = UDim.new(0, 15) -- Margen interno para el texto
SearchPadding.Parent = KittySearch

-- Botón Search Rosado Sólido
local KittySearchBtn = Instance.new("TextButton")
KittySearchBtn.Size = UDim2.new(0.3, -15, 0, 40)
KittySearchBtn.Position = UDim2.new(0.7, 5, 0.5, -20)
KittySearchBtn.BackgroundColor3 = Color3.fromRGB(255, 20, 147) -- Rosado intenso (Deep Pink)
...
-- Sidebar: Toma el 25% del ancho izquierdo
...
-- Resultados: Toma el 75% del ancho derecho, debajo del topbar
...
ResultsLayout.CellSize = UDim2.new(0, 130, 0, 180) -- Un poco más pequeño para adaptarse a móviles
...
-- Vincular búsqueda a tecla Enter y al botón rosado
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v9.2",
   LoadingTitle = "Motor Unificado v9.2...",
...
Panel:CreateToggle({
   ...
   Callback = function(Value)
       ...
       if Value then
           Rayfield:Notify({Title = "🎀 Menú Kitty", Content = "¡El menú ha sido optimizado para tu pantalla!", Duration = 3})
       end
   end,
})
