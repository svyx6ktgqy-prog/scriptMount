-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (UNIFICADO v9.6 + KITTY MENU)
-- Fix UI + Scroll Categories + Native Purchase + Hybrid Equip
-- ==========================================================
...
-- ==========================================================
-- SISTEMA DE EQUIPAMIENTO HÍBRIDO CIRUGÍA APLICADA
-- ==========================================================
local function UniversalEquip(assetId)
    task.spawn(function()
        ...
        -- MÉTODO 2: HUMANOID DESCRIPTION (Solo para Accesorios 3D y Pelo)
        local successDesc, err = pcall(function()
            local desc = Hum:GetAppliedDescription()
            
            if typeId == 8 then desc.HatAccessory = desc.HatAccessory == "" and tostring(assetId) or desc.HatAccessory .. "," .. tostring(assetId)
        ...
        if not successDesc then
            warn("Error al equipar 3D: ", err)
        end
    end)
end

-- ==========================================================
-- SISTEMA DE VISUALIZADOR HUD (COMPRA INTELIGENTE REPARADA)
-- ==========================================================
...
-- FIX COMPRA: Al estar en PlayerGui, Roblox sí permite abrir la ventana nativa
