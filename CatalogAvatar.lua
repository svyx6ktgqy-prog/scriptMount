...
-- Aplica ajustes de transformación guardados previamente a un accesorio activo
...
local function RefreshSavedCharactersGrid()
    ...
    for charName, charData in pairs(data) do
        -- Compatibilidad entre formato clásico (array de IDs) y nuevo formato (tabla con datos)
        ...
        LoadBtn.MouseButton1Click:Connect(function()
            ...
            -- Re-aplicación automatizada de transformaciones personalizadas guardadas
...
SaveCharBtn.MouseButton1Click:Connect(function()
    ...
    -- Recopilar ajustes de accesorios activos
