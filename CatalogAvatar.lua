-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v25.5 ANTI-FREEZE & ULTRA-ASYNC)
...
-- + [NUEVO] EDIT PARTS (Eliminar partes del cuerpo guardables)
-- ==========================================================
...
local SavedBodyModifiers = {} -- [NUEVO] Registro de partes del cuerpo ocultas
...
PartsLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
    PartsScroll.CanvasSize = UDim2.new(0, 0, 0, PartsLayout.AbsoluteContentSize.Y + 10)
end)
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v25.5 Ultra-Async",
