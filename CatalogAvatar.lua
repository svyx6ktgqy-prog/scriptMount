-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.7 FIXED ZOOM & HEIGHT)
-- Miniatura Reencuadrada + Menú Adaptativo Múltiples Pantallas
-- ==========================================================
...
EqPanel.Size = UDim2.new(0, 350, 0, 280)
...
-- ==========================================================
-- SISTEMA DE PERSONAJES GUARDADOS (REAJUSTE MÓVIL Y ZOOM)
-- ==========================================================
local CharMenu = Instance.new("Frame")
CharMenu.Size = UDim2.new(0, 360, 0, 280)
...
CharMenuConstraint.MaxSize = Vector2.new(360, 280)
...
NameInput.Size = UDim2.new(0, 210, 0, 30)
NameInput.Position = UDim2.new(0, 12, 0, 38)
...
SaveCharBtn.Size = UDim2.new(0, 110, 0, 30)
SaveCharBtn.Position = UDim2.new(1, -122, 0, 38)
...
CharScroll.Size = UDim2.new(1, -24, 1, -80)
CharScroll.Position = UDim2.new(0, 12, 0, 74)
...
CharGrid.CellSize = UDim2.new(0, 100, 0, 135)
...
local function RefreshSavedCharactersGrid()
    ...
    for charName, itemIds in pairs(data) do
        ...
        Card.Size = UDim2.new(0, 100, 0, 135)
        ...
        Viewport.Size = UDim2.new(1, -10, 0, 72)
        ...
        -- CONSTRUCCIÓN DE MINIATURA (REENCUADRADA EN DISTANCIA COMPLETA)
        task.spawn(function()
            ...
            if primary then
                -- ENCUADRE DE CUERPO ENTERO PERFECCIONADO
                cam.CFrame = CFrame.new(
                    primary.Position + (primary.CFrame.LookVector * 5.2) + Vector3.new(0, 0.5, 0), 
                    primary.Position + Vector3.new(0, 0.2, 0)
                )
            end
        end)
        ...
        LabelName.Position = UDim2.new(0, 5, 0, 80)
        ...
        LoadBtn.Position = UDim2.new(0, 5, 1, -27)
        ...
        DelBtn.Position = UDim2.new(1, -27, 1, -27)
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Aplicando Zoom & Height Fix...",
