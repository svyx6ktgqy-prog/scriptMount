...
-- Animaciones + Fix Ropa 3D + Auto-Ocultar Piernas
-- ==========================================================
            ...
            if item:IsA("Accessory") then
                ...
                if handle then
                    ...
                    if wrapLayer then
                        ...
                        -- NUEVO: Detectar si es pantalón y ocultar las piernas base
                        local isPant = false
                        pcall(function()
                        ...
                        if isPant then
                            cloneItem:SetAttribute("HidesLegs", true) -- Marca para saber qué restaurar luego
                            for _, part in ipairs(Char:GetChildren()) do
                                if part:IsA("BasePart") then
                                    local pName = string.lower(part.Name)
                                    if string.find(pName, "leg") or string.find(pName, "foot") then
...
RefreshEquippedItems = function()
    ...
    for _, item in ipairs(items) do
        ...
        btn.MouseButton1Click:Connect(function()
            ...
            -- NUEVO: Restaurar piernas si el item las ocultó
