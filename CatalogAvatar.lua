-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.5 ANIMATED PREVIEW FIX)
...
-- ==========================================================
-- SISTEMA DE PERSONAJES GUARDADOS (CHARACTERS.json) [ACTUALIZADO UI]
-- ==========================================================
local CharMenu = Instance.new("Frame")
CharMenu.Size = UDim2.new(0.9, 0, 0.8, 0) -- Responsive: Toma 90% del ancho y 80% del alto
...
-- Constraint para PC (no hacerse gigante) y Móvil (no hacerse microscópico)
...
NameInput.Size = UDim2.new(1, -145, 0, 36) -- Tamaño en escala que deja espacio exacto para el botón
...
SaveCharBtn.Position = UDim2.new(1, -125, 0, 45) -- Siempre anclado a la derecha sin solaparse
...
CharScroll.Size = UDim2.new(1, -30, 1, -100) -- Altura dinámica (rellena el marco menos el área del input superior)
CharScroll.Position = UDim2.new(0, 15, 0, 90)
...
CharGrid.CellSize = UDim2.new(0, 105, 0, 140) -- Mantenemos fijo el tamaño de carta para que no se deforme el render 3D
CharGrid.CellPadding = UDim2.new(0, 10, 0, 10)
CharGrid.HorizontalAlignment = Enum.HorizontalAlignment.Center -- Si la pantalla es ancha, centra las cartas con elegancia
