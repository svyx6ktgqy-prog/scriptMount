-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (UNIFICADO v9.3 + KITTY MENU)
-- Botón Flotante + Fix de Textos/Scroll + Fix de Compras
-- ==========================================================
...
-- FIX COMPRA: Diferenciar entre Bundles y Assets normales
...
FloatingBtn.Image = "rbxassetid://15538455161" -- Tu ID de imagen
FloatingBtn.BackgroundTransparency = 1
FloatingBtn.Visible = false 
FloatingBtn.Parent = KittyGui

-- Lógica para hacer el botón flotante arrastrable
...
-- Al tocar el botón flotante, se esconde y abre el menú
...
-- Contenedor del Input (Fix del Padding)
...
-- Input Elegante y sin Bugs de Salto
local KittySearch = Instance.new("TextBox")
KittySearch.Size = UDim2.new(1, -20, 1, 0)
KittySearch.Position = UDim2.new(0, 10, 0, 0) -- Margen izquierdo en lugar de UIPadding
...
-- Resultados (Fix del Scroll Infinito)
...
KittyResults.AutomaticCanvasSize = Enum.AutomaticSize.Y -- FIX SCROLL
        ...
        if decoded and decoded.data then
            for _, item in ipairs(decoded.data) do
                ...
                ClickBtn.MouseButton1Click:Connect(function()
                    ...
                    CurrentData.ItemType = item.itemType or "Asset" -- Guarda si es Bundle o Asset
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v9.3",
   LoadingTitle = "Motor Unificado v9.3...",
   LoadingSubtitle = "Fix Scroll + Botón Flotante + Compras",
