-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.6 ZOOM & LIMITS FIX)
...
CharScroll.Size = UDim2.new(1, -30, 1, -90)
CharScroll.Position = UDim2.new(0, 15, 0, 80)
...
local function RefreshSavedCharactersGrid()
    ...
    for charName, itemIds in pairs(data) do
        ...
        -- CONSTRUCCIÓN DE MINIATURA EN ZOOM ACERCADO (HD FOCUS)
        task.spawn(function()
            ...
            if primary then
                -- ENCUADRE DE CÁMARA AJUSTADO PARA EVITAR BORDES SOBRESALIENTES
                cam.CFrame = CFrame.new(
                    primary.Position + (primary.CFrame.LookVector * 3.4) + Vector3.new(0, 0.2, 0), 
...
KittyMain.Size = UDim2.new(0.85, 0, 0.85, 0) 
...
KittyConstraint.MaxSize = Vector2.new(720, 480) 
KittyConstraint.MinSize = Vector2.new(320, 260)
...
KittyTop.ClipsDescendants = true
...
SearchContainer.Size = UDim2.new(0.58, 0, 0, 40)
...
KittySearchBtn.Position = UDim2.new(0.60, 10, 0.5, -20)
...
KittySidebar.ClipsDescendants = true
...
KittyResults.ClipsDescendants = true
...
ResultsLayout.CellSize = UDim2.new(0, 125, 0, 175) 
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Aplicando Zoom & Limits Fix...",
