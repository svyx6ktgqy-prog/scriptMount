-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.6 MINIATURA FIX)
...
-- ==========================================================
-- SISTEMA DE PERSONAJES GUARDADOS (CHARACTERS.json) - REESTRUCTURACIÓN ESTÉTICA ÚNICA
-- ==========================================================
local CharMenu = Instance.new("Frame")
CharMenu.Size = UDim2.new(0, 460, 0, 420) -- Ajuste de tamaño premium para simetría táctil y PC
CharMenu.Position = UDim2.new(0.5, 0, 0.5, 0)
CharMenu.AnchorPoint = Vector2.new(0.5, 0.5)
CharMenu.BackgroundColor3 = Color3.fromRGB(25, 25, 25) -- Tema Dark Mode Antracita
...
local CharStroke = Instance.new("UIStroke"); CharStroke.Color = Color3.fromRGB(255, 105, 180); CharStroke.Thickness = 2; CharStroke.Parent = CharMenu -- Contorno Neon Hot Pink
...
SaveCharBtn.BackgroundColor3 = Color3.fromRGB(50, 205, 50) -- Tono Verde Guardar Activo
...
CharGrid.CellSize = UDim2.new(0, 105, 0, 140) -- Diseño de tarjetas verticales responsivas estilo coleccionables
...
local function RefreshSavedCharactersGrid()
    ...
    for charName, itemIds in pairs(data) do
        ...
        Card.BackgroundColor3 = Color3.fromRGB(40, 40, 40) -- Contenedor interno gris oscuro unificado
        ...
        -- CONTENEDOR DE VISTA PREVIA AUTOMÁTICA COHESIVO
        local Viewport = Instance.new("ViewportFrame")
        Viewport.Size = UDim2.new(1, -10, 0, 75)
        Viewport.Position = UDim2.new(0, 5, 0, 5)
        Viewport.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Relieve interior oscuro para el render
        Viewport.BackgroundTransparency = 0
        Viewport.ClipsDescendants = true
        Viewport.Parent = Card
        local VCorner = Instance.new("UICorner"); VCorner.CornerRadius = UDim.new(0, 6); VCorner.Parent = Viewport

        -- CONSTRUCCIÓN DE MINIATURA UNIVERSAL (CON O SIN ANIMACIÓN)
        task.spawn(function()
            ...
            -- 1. Limpiar ropa y accesorios previos del mannequin base
            ...
            -- Asegurar fijación temporal para evitar caídas por física
            local hrp = dummy:FindFirstChild("HumanoidRootPart") or dummy.PrimaryPart
            if hrp then hrp.Anchored = true end

            dummy.Parent = workspace

            -- Procesador de ítems para el Mannequin del Viewport
            ...
            -- 2. Equipar todos los elementos guardados del outfit
            for _, id in ipairs(itemIds) do
                ...
                -- Si es una animación directa por AssetId
            ...
            -- Dar un tiempo de refresco universal para que Roblox aplique texturas, welds y joints
            task.wait(0.2)

            -- 3. Fijar partes estáticas para renderizado estático perfecto en Viewport
            ...
            -- 4. Insertar en WorldModel dentro del ViewportFrame para garantizar renderizado
        ...
        LoadBtn.BackgroundColor3 = Color3.fromRGB(255, 105, 180) -- Botón Rosa Neón para Cargar Outfit
        LoadBtn.Text = "Cargar"
        ...
        DelBtn.BackgroundColor3 = Color3.fromRGB(255, 50, 50) -- Botón Rojo para Eliminar Outfit
        DelBtn.Text = "🗑️"
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v23.6",
   LoadingTitle = "Aplicando Preview & Miniatura Fix...",
