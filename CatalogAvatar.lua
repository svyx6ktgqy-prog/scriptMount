-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.8 FIX LAYERS & MOBILE UI)
...
-- ==========================================================
-- SISTEMA DE PERSONAJES GUARDADOS (CHARACTERS.json) - REESTRUCTURACIÓN Y MOBILE FIX
-- ==========================================================
...
local NamePadding = Instance.new("UIPadding"); NamePadding.PaddingLeft = UDim.new(0, 8); NamePadding.Parent = NameInput
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v23.8",
