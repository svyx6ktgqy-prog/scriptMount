-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v25.1 ANTI-FREEZE FIX + PRELOAD)
-- Renderizado Asíncrono + Carga Escalonada + Switch Muerte Real
-- ==========================================================
...
-- ==========================================================
-- SISTEMA DE PRECARGA E INICIALIZACIÓN PREVIA (ANTI-FREEZE)
-- ==========================================================
local CachedDefaultDescription = nil

task.spawn(function()
    -- 1. Precargar información y descripción del avatar original en segundo plano
    pcall(function()
        CachedDefaultDescription = Players:GetHumanoidDescriptionFromUserId(LocalPlayer.UserId)
    end)

    -- 2. Asegurar que la estructura de archivos local esté leída antes de interacciones
    ...
    -- 3. Precarga de Assets críticos de UI en el buffer del motor
    local assetsToPreload = {
        "rbxassetid://13307406982", -- Logo Eyes
        "rbxassetid://15538455161", -- Kitty Icon
        "rbxassetid://11560341824"  -- Robux Icon
    }
    pcall(function()
...
-- ==========================================================
-- 1. RESTAURACIÓN A AVATAR DEFAULT (RESET TOTAL OPTIMIZADO)
-- ==========================================================
...
-- ==========================================================
-- LÓGICA DE PERSISTENCIA AL MORIR (SWITCH ENTRADA/SALIDA)
-- ==========================================================
...
-- ==========================================================
-- SISTEMA DE PERSONAJES GUARDADOS (OPTIMIZADO CON DEFER & THROTTLE)
-- ==========================================================
...
local function RefreshSavedCharactersGrid()
    ...
    -- Bucle asíncrono distribuidor para evitar congelar la pantalla con muchos outfits
    task.spawn(function()
        for charName, itemEntries in pairs(data) do
            ...
            -- Carga de Outfit Escalonada (Cero Lag / Freeze)
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v25.1",
