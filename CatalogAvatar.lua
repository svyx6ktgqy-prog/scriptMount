-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (UNIFICADO v8.0)
-- Con Lógica de Equipamiento GetObjects v3.0 Integrada
-- ==========================================================
...
local Window = Rayfield:CreateWindow({
   Name = "🏥 Avatar Catalog Quirúrgico Pro v8.0",
   LoadingTitle = "Motor v3.0 Integrado...",
   LoadingSubtitle = "Equipamiento GetObjects Natural",
...
-- ==========================================================
-- 1. BUSCADOR EN VIVO Y CASCADA DE RESULTADOS
-- ==========================================================
...
Panel:CreateButton({
   ...
   Callback = function()
       ...
       -- MÉTODO PRECISO V3.0: Usar GetObjects (Bypasea restricciones de InsertService)
