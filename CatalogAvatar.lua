-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (v23.7 MINIATURA & ADJUSTMENT FIX)
-- Miniatura Estática x Outfit + Pose + Ajustes Personalizados Guardados
-- ==========================================================
...
local function RefreshSavedCharactersGrid()
    ...
    for charName, itemEntries in pairs(data) do
        ...
        task.spawn(function()
            ...
            -- 2. Equipar e incluir ajustes de transformaciones para la miniatura
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Aplicando Preview & Adjustment Fix...",
