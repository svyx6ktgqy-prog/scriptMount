-- ==========================================================
-- MENU DE AVATARES QUIRÚRGICO Y PRO (UNIFICADO v9.0)
-- Buscador Directo Restaurado + Centrado de Precio + Motor v3.0
-- ==========================================================
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Motor Unificado v9.0...",
...
-- ==========================================================
-- 1. BUSCADOR DIRECTO (ENDPOINT EXTRAÍDO DE LA V7.0)
-- ==========================================================
...
Panel:CreateInput({
   ...
   Callback = function(Text)
       ...
       -- Conexión directa extraída de la v7.0
       ...
       -- Respaldo a RoProxy si la llamada directa es bloqueada
...
Panel:CreateButton({
   ...
   Callback = function()
       ...
       -- Protección anti-crash para juegos (Places)
       ...
       -- MÉTODO PRECISO V3.0: Usar GetObjects
