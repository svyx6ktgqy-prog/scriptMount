					...
					if p ~= player and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
						...
						if hasBasketball then
							...
							if dist <= Mobile_StealDist then
								-- Alinear mirada hacia la bola para aumentar la eficiencia del robo
				...
				if targetRim then
					for _, p in ipairs(Players:GetPlayers()) do
						if p ~= player and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
							...
							-- Si el rival está atacando el aro y nosotros estamos lo suficientemente cerca para taponar
