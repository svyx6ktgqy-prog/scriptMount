-- Universal Basketball 0.2 Script (Fixed for Delta iOS & Rayfield UI + Dynamic Auto-Aim)
...
-- Pestañas de Rayfield (Definidas al inicio para garantizar su renderizado)
...
FloatBtn.Activated:Connect(function()
	...
	if shootBtn and shootBtn.Visible then
		-- 1. Detectar y auto-rotar hacia el aro más cercano
		local targetRim = getClosestRim()
		if targetRim then
			alignCharacterToRim(targetRim)
		end

		-- 2. Ejecutar rutina de tiro
