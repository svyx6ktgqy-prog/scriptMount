...
local Mobile_CorruptSteal = false -- NUEVA VARIABLE CORRUPT STEAL
...
-- Función obsoleta/inestable para robar, mantenida solo como backup
...
-- ==========================================
-- BOTÓN FLOTANTE AUTOSHOOTV (COMPATIBLE CON DELTA iOS)
-- ==========================================
