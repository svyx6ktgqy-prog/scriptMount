--[[
    Catalog Native Buyer v16 (Delta/Mobile Ultimate Fix + V18 patches)
    - Fix V18: Evita que el juego se congele ("No responde") al descargar usando hilos asíncronos puros.
    - Fix V18: Resuelto el error de "archivo vacío" obteniendo la imagen directamente desde rbxcdn.
    - Fix V18: Prioridad a openurl() para abrir Safari/Chrome directamente al tocar.
    - Mantiene el sistema de prompt nativo avanzado, UI completa y Smart Browser de V16.
]]
...
local function openSmartBrowser(url)
    -- 1. Intentar navegador externo del celular (Safari/Chrome) al instante (prioridad V18)
...
-- ===================== DESCARGA DE IMAGEN HD (ANTI-CONGELAMIENTO + rbxcdn) =====================
...
local function promptNativePurchase(assetId, itemType, itemName)
    ...
    local log = {}
    table.insert(log, "=== LOG PROMPT NATIVO v16 (Delta + V18) ===")
...
local function createMenu()
    ...
    print("[Catalog Native Buyer v16] Sistema Anti-Lag + rbxcdn + Navegador Híbrido (V18 patches) Activos")
    notify("v16 Listo", "Directo a Safari/Chrome + Anti Lag + Imágenes rbxcdn", 5)
end
