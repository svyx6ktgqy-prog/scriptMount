...
-- Calcula el origen del láser directamente desde la mano elevándolo hasta el cañón
local function getLaserStartPoint(character)
    ...
    if manoDerecha then
        -- MODIFICADO: Elevamos a +0.65 en Y (más arriba) y adelantamos a -2.2 en Z (pico de disparo)
        local laserOriginCF = manoDerecha.CFrame * CFrame.new(0, 0.65, -2.2)
