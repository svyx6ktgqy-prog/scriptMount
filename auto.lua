...
-- Modo: Aim Autónomo + Pegado Espalda + Auto-Equip + Touch AutoClick Fire
...
-----------------------------------------------------
-- AUTOCLICK DE DISPARO AL MANTENER / TOCAR LA PANTALLA
-----------------------------------------------------
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    ...
    if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
        ...
        -- Bucle de autoclick continuo mientras mantengas presionado fuera de los botones
        task.spawn(function()
            while IsTouchingScreen and AutoFireTouchEnabled do
                ...
                task.wait(0.01) -- Velocidad de autoclick ultrarrápida
            end
        end)
    end
end)
