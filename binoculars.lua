...
local Window = Rayfield:CreateWindow({
   Name = "Tactical Gear: ULTRA V4.1",
   LoadingTitle = "Applying Surgical Smoothing...",
   LoadingSubtitle = "Rotation & Sensitivity Patched",
...
Tab:CreateButton({
   ...
   Callback = function()
       local success, errorMessage = pcall(function()
           ...
           sliderBg.Size = UDim2.new(0, 50, 0.6, 0)
           sliderBg.Position = UDim2.new(1, -90, 0.2, 0)
           ...
           sliderKnob.Size = UDim2.new(1, 0, 0, 35)
           sliderKnob.Position = UDim2.new(0, 0, 1, -35)
           ...
           -- LOGICA DE EQUIPADO Y RENDERIZADO
           tool.Equipped:Connect(function()
               ...
               renderConnection = RunService.RenderStepped:Connect(function(deltaTime)
                   ...
                   -- [FIX 2]: SUAVIZADO VISUAL PERFECTO
                   ...
                   if isAiming then
                       ...
                       -- Sensibilidad escalada 1:1 con el zoom (evita movimientos bruscos en x40)
                       pcall(function()
                           userSettings.MouseSensitivity = math.clamp(baseSensitivity * fovRatio, 0.0005, baseSensitivity)
                       end)
                   end

                   -- PROCEDURAL SWAY & BOBBING (Reducido por el fovRatio para evitar temblores excesivos)
                   ...
                   -- RENDERIZADO DEL VIEWMODEL [FIX 1]: CORRECCIÓN DE ROTACIÓN
                   if viewModel and viewModel.PrimaryPart then
                       -- Se añadió * CFrame.Angles(0, math.pi/2, 0) para que mire derecho de frente
           ...
           Rayfield:Notify({Title = "V4.1 ACTIVE", Content = "Rotation Straightened & Aiming Smoothed.", Duration = 4})
       end)
