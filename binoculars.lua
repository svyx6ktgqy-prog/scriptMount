...
local function buildBinocularModel(parent, isViewModel)
    ...
    if not isViewModel then
        ...
        -- [FIX V4]: Ocultamos el ViewModel apenas se crea para que no aparezca flotando
...
Tab:CreateButton({
   ...
   Callback = function()
       local success, errorMessage = pcall(function()
           ...
           -- [FIX V4]: El fondo del slider AHORA es el botón y un poco más ancho.
           ...
           sliderKnob.Active = false -- [CRÍTICO]: Deja que los clicks pasen al fondo
           ...
           -- [FIX V4]: INPUT DEL SLIDER PERFECCIONADO
           ...
           local function toggleAim()
               ...
               if isAiming then
                   ...
                   -- Ocultar herramienta del personaje y Mostrar ViewModel
                   ...
                   -- Mostrar herramienta del personaje y Ocultar ViewModel (FIX CLON)
                   for _, part in pairs(tool:GetDescendants()) do
           ...
           Rayfield:Notify({Title = "V4 ACTIVE", Content = "Bugs resolved: Smooth slider & No clones.", Duration = 4})
       end)
