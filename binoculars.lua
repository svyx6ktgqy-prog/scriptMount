...
local Window = Rayfield:CreateWindow({
   Name = "Tactical Gear: ULTRA V5.1",
   LoadingTitle = "Fixing Gimbal Lock...",
   LoadingSubtitle = "Camera Roll & Rotation Patched",
   ...
   Callback = function()
       local success, errorMessage = pcall(function()
           ...
           local function updateSensSlider(inputPos)
               ...
               lentitudMultiplier = 1 + (percentage * 99)
           ...
           local function toggleAim()
               ...
               if isAiming then
                   ...
                   -- [FIX CRÍTICO]: Extraemos la orientación correcta (Pitch, Yaw, Roll)
               ...
               renderConnection = RunService.RenderStepped:Connect(function(deltaTime)
                   ...
                   if isAiming then
                       ...
                       if char and char:FindFirstChild("Head") then
                           ...
                           -- [FIX CRÍTICO]: CFrame.fromOrientation evita que la cámara se incline de lado
                           Camera.CFrame = CFrame.new(headPos) * CFrame.fromOrientation(currentCamRotation.X, currentCamRotation.Y, 0)
                           
                           -- Opcional: Hacer que el cuerpo del jugador rote con la cámara
           ...
           Rayfield:Notify({Title = "V5.1 ACTIVE", Content = "Gimbal Lock Patched & Body Rotation Synced.", Duration = 4})
       end)
