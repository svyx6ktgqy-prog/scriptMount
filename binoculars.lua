...
local TweenService = game:GetService("TweenService") -- Añadido para movimientos suaves
...
Tab:CreateButton({
   ...
   Callback = function()
       local success, errorMessage = pcall(function()
           ...
           crosshair.Image = "rbxassetid://9036711587" -- NUEVO CROSSHAIR ACTUALIZADO
           ...
           -- Variables para la sensibilidad del ratón
           ...
           local function toggleAim(forceOff)
               ...
               if isAiming then
                   baseSensitivity = userSettings.MouseSensitivity -- Guardamos la sensibilidad original
                   crosshair.Visible = true
                   sliderBg.Visible = true
                   
                   -- Transición suave de FOV inicial
                   ...
                   if rightShoulder then
                       ...
                       aimAnimConnection = RunService.RenderStepped:Connect(function()
                           ...
                           -- Ajuste dinámico y suave de sensibilidad (A más zoom, menos sensibilidad)
                           pcall(function()
                               userSettings.MouseSensitivity = baseSensitivity * (Camera.FieldOfView / defaultFOV)
                           end)
                       end)
                   end
               else
           ...
           -- 5. Eventos del Slider (AHORA SUAVES)
           ...
           UserInputService.InputChanged:Connect(function(input)
               if draggingSlider and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                   ...
                   -- Restringir (Clamp) para que no se salga de los bordes
                   ...
                   if isAiming then
                       -- Movimiento del ZOOM de la cámara suave
           ...
           -- 6. FABRICAR EL MODELO (Corregido fallo "0. NULL")
           tool.Equipped:Connect(function() 
               ...
               binoVisual.Anchored = false -- Evita errores de físicas
               binoVisual.CFrame = hand.CFrame -- Se posiciona ANTES de soldarse
               ...
               if char:FindFirstChild("RightHand") then
                   weld.C0 = CFrame.new(0, -0.15, 0) * CFrame.Angles(math.rad(-90), 0, 0)
               else
