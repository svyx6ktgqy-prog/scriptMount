...
Tab:CreateButton({
   ...
   Callback = function()
       local success, errorMessage = pcall(function()
           ...
           local playerGui = Player:WaitForChild("PlayerGui", 5) -- Espera hasta 5 segundos
           
           if not playerGui then
               error("No se pudo encontrar PlayerGui.")
           end
           ...
           -- Ensure tool is placed in Backpack safely
       ...
       -- SI HAY UN ERROR, RAYFIELD TE DIRÁ EXACTAMENTE QUÉ PASÓ:
       if not success then
