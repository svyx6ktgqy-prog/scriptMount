...
Tab:CreateButton({
   ...
   Callback = function()
       local success, errorMessage = pcall(function()
           ...
           -- 1. Cargar el Tool Oficial usando game:GetObjects() (MÉTODO PARA EXECUTORS)
           local tool = nil
           local successLoad, loadError = pcall(function()
               -- 34918681 es el ID oficial de los Binoculars de Roblox
               local objects = game:GetObjects("rbxassetid://34918681")
           ...
           if not successLoad or not tool then
               error("Tu executor no pudo cargar el asset. Intenta de nuevo. Detalle: " .. tostring(loadError))
           end

           -- Limpiamos scripts viejos o inútiles que traiga el modelo oficial para que no interfieran
