...
Tab:CreateButton({
   ...
   Callback = function()
       local success, errorMessage = pcall(function()
           ...
           -- 1. CONSTRUIR EL TOOL MANUALMENTE (Evita errores de Executor)
           local tool = Instance.new("Tool")
           tool.Name = "Binoculars"
           tool.RequiresHandle = true
           tool.CanBeDropped = false
           tool.Grip = CFrame.new(0, 0, 0) -- Agarre estándar
           ...
           -- Usamos las mallas oficiales clásicas de los binoculares de Roblox (No fallan nunca)
           local mesh = Instance.new("SpecialMesh")
           mesh.MeshType = Enum.MeshType.FileMesh
           mesh.MeshId = "rbxassetid://13054174"     -- ID oficial de la forma 3D
           mesh.TextureId = "rbxassetid://13054199"  -- ID oficial de los colores
           ...
           local function toggleAim(forceOff)
               ...
               if isAiming then
                   -- MODO APUNTAR: Primera persona, zoom y UI activa
                   ...
                   -- Rotar el arma para que se vea bien apuntando
                   ...
                   -- MODO NORMAL: Mano caída, cámara libre
                   crosshair.Visible = false
                   sliderBg.Visible = false
           ...
           -- 6. Eventos del Slider de Zoom (x2 a x20)
