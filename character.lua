...
StatusLbl.Text = "Keep on Death ON • Mantén 👀 = Guardar skins"
...
Scroll.AutomaticCanvasSize = Enum.AutomaticSize.Y   -- ← clave para no esconder items
Scroll.Parent = Main
...
SkinsScroll.ElasticBehavior = Enum.ElasticBehavior.Always
...
Notify("Looks Pro v10 listo", "Scroll pro • Gestor de skins completo", 5)
