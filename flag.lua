...
aplicarOutfitYBandera = function(Value)
    ...
    if isSystemActive then
        -- Memorizar si la bandera estaba equipada en la mano antes de recargar
        local estabaEquipada = char:FindFirstChild("Bandera Realista") ~= nil

        Rayfield:Notify({Title = "Procesando", Content = "Aplicando outfit, bandera y color...", Duration = 2})
        ...
        local elevacionGorro = 0.08 -- Elevado según lo solicitado
        ...
        if estabaEquipada then
            flagTool.Parent = char -- Al asignarlo al personaje, se equipa en la mano al instante
        else
        ...
        Rayfield:Notify({Title = "¡Éxito!", Content = "Equipamiento actualizado.", Duration = 3})
