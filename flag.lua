...
local presetColors = {
    ["NEGRON"] = Color3.fromRGB(25, 25, 25),          -- Oscuro casi negro
    ["Spyder550"] = Color3.fromRGB(180, 180, 180),    -- Gris/Plata
    ["Glade"] = Color3.fromRGB(34, 139, 34),          -- Verde destacado
    ["Darkwole"] = Color3.fromRGB(30, 30, 45),        -- Azul/Gris oscuro
    ["Camufla"] = Color3.fromRGB(85, 107, 47),        -- Verde militar oscuro
    ["CatOnge"] = Color3.fromRGB(255, 140, 0),        -- Naranja intenso
    ["Panic-Attack"] = Color3.fromRGB(178, 34, 34)    -- Rojo intenso
}

local currentTextureUrl = texturePresets["NEGRON"]
local currentPreset = "NEGRON" -- Rastrear si usamos preset o custom
local customInputUrl = ""
local customAssetId = ""
local customPoleColor = Color3.fromRGB(150, 150, 150) -- Color por defecto para Custom
local fileCounter = 0
...
-- Declaración anticipada de la función principal
...
-- 4. Color Picker para el Palo (Solo aplica en Custom URLs)
Tab:CreateColorPicker({
    ...
    Callback = function(Value)
        ...
        -- Actualizar en tiempo real si el sistema está activo y es una URL custom
...
aplicarOutfitYBandera = function(Value)
    ...
    if isSystemActive then
        ...
        -- Calcular Color del Palo Automáticamente
        ...
        if currentPreset and presetColors[currentPreset] then
            ...
            flagPoleColor = customPoleColor -- Fallback interactivo para imágenes custom
        end
        ...
        handleFlag.Color = flagPoleColor -- AQUÍ SE APLICA EL COLOR AUTOMÁTICO
