...
Tab:CreateToggle({
   ...
   Callback = function(Value)
        ...
        if isSystemActive then
            ...
            -- ======================================================
            -- 2. GORRO CUBETA CON TEXTURAS APLICADAS
            -- ======================================================
            ...
            local function crearLoseta(nombre, tamano, alturaY)
                ...
                if textureId ~= "" then
                    bloque.Color = Color3.fromRGB(255, 255, 255) -- Base blanca para no alterar el color de la textura
                    
                    -- Aplicar textura a las 6 caras del cubo
                    local caras = {
                    ...
                    for _, cara in ipairs(caras) do
                        local texturaCara = Instance.new("Texture")
                        texturaCara.Texture = textureId
                        texturaCara.Face = cara
                        texturaCara.StudsPerTileU = 1.5 -- Escala del patrón de la textura
                        texturaCara.StudsPerTileV = 1.5
                        texturaCara.Parent = bloque
                    end
                else
                    bloque.Color = Color3.fromRGB(18, 18, 18) -- Si falla la textura, usar negro oscuro
                end
                
                -- Posicionar matemáticamente sobre el centro de la cabeza
                bloque.CFrame = head.CFrame * CFrame.new(0, alturaY, 0)
