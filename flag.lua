        ...
        pcall(function()
            ...
            if myHead then
                for _, sub in ipairs(myHead:GetDescendants()) do
                    if sub:IsA("Decal") or sub:IsA("Texture") or sub:IsA("FaceControls") or sub.Name == "face" then
                        sub:Destroy()
                    end
                end
            ...
            local function aplicarPaquete(assetId, soloPiernas)
                ...
                for _, rootObj in ipairs(objects) do
                    for _, item in ipairs(rootObj:GetDescendants()) do
                        ...
                        -- Ignorar ropa o accesorios propios del paquete
                        ...
                        if item:IsA("MeshPart") then
                            ...
                            if (soloPiernas and esPierna) or (not soloPiernas and not esPierna) then
                                ...
                                if targetPart and targetPart:IsA("MeshPart") then
                                    ...
                                    -- Copiar Attachments para reajustar hombros, codos y muñecas
            ...
            -- 5. RECONSTRUIR PUNTOS DE UNIÓN DEL HUMANOIDE (Solución a partes flotantes)
            task.wait(0.1)
