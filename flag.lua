...
-- =========================================================
-- SISTEMA QUIRÚRGICO DE ASSETS (INYECCIÓN DIRECTA SIN CATÁLOGO)
-- =========================================================
...
local function aplicarModificacionesCuerpo(char)
    -- 1. Limpieza total: remover ropa, pelo y accesorios
    ...
    -- 2. Cargar personaje base (ID: 11058199848)
    ...
    if legsAsset then
        -- Remover meshes de piernas existentes
        ...
        -- Extraer e inyectar únicamente las piernas del nuevo personaje
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Generando físicas y outfit quirúrgico...",
...
aplicarOutfitYBandera = function(Value)
    ...
    if isSystemActive then
        Rayfield:Notify({Title = "Procesando", Content = "Inyectando cuerpo, piernas y físicas...", Duration = 2})
        
        -- Inyección quirúrgica del cuerpo, piernas y pantalones
        ...
        Rayfield:Notify({Title = "¡Éxito!", Content = "Inyección completada sin restricciones.", Duration = 3})
    else
