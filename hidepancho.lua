-- Cargar librería Rayfield desde el link personalizado para Delta
...
local Window = Rayfield:CreateWindow({
   ...
   Discord = {
      Enabled = false, -- Desactivado para evitar crasheos en el celular
      Invite = "", 
      RememberJoins = false 
   },
   KeySystem = false
...
Rayfield:Notify({
   ...
   Content = "Interfaz cargada correctamente en Delta.",
   Duration = 5,
   Image = 4483362458
})
