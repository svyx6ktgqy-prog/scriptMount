...
-- =====================================================================
-- PESTAÑA 2: 👁️ VISUALES Y ESP (LIMPIADA Y UNIFICADA)
-- =====================================================================
...
-- Único Bucle unificado para Ores
task.spawn(function()
...
MapTab:CreateButton({
    ...
    Callback = function()
        ...
        if not root then return end
        local found = false
        local keywords = {"portal", "teleport", "nextmap", "nextzone", "gate", "door", "area", "zone"}
        for _, part in ipairs(workspace:GetDescendants()) do
            if part:IsA("BasePart") then
...
-- 🎭 APARTADO TROLL (Ahora dentro de la pestaña correcta)
                        ...
                        if targetPlayer and targetPlayer.Character and LocalPlayer.Character then
                            ...
                            if targetRoot and targetHum and localRoot and localHum then
                                ...
                                if targetHum.MoveDirection.Magnitude == 0 then
                                    ...
                                    if distanceToShadow > 1.2 then localHum:MoveTo(behindPosition) end
                                end
