...
local IDsPersonajes = {
    ...
    ["SpyEffect"] = "2614544836",
    ["DemonSuite"] = "14288252360",
    ["BearBlack"] = "10059678189",
    ["KingV1"] = "1502622602",
    ["KingV2"] = "10332438725",
    ["Ninjaco80"] = "10926342089",
    ["CJ"] = "110223007877573",
    ["MeKing"] = "49618066",
    ["JasonX"] = "17462621551",
    ["PandiMan"] = "2482936370",
    ["AppleJuice"] = "5231922649",
    ["Tr$xshV2"] = "17357198199",
    ["SuiteWhiteFF"] = "149649724",
    ["Otaku"] = "10066776256",
    ["Halloween"] = "182828338",
    ["HalloweenV2"] = "16191227563",
    ["HalloweenV3"] = "314579152",
    ["HalloweenV4"] = "4515633485",
    ["Anime"] = "12620017502",
    ["Pet-Skyler"] = "16305734736",
    ["Tattoo"] = "2471099435",
    ["Necklace"] = "10253040",
    ["HellxCult"] = "6231360322",
    ["Pepperm3n"] = "5219495877",
    ["BattleCAT"] = "140280149057407",
    ["Yamal-Lamine"] = "73762465274540",
    ["NecroL"] = "5077070408",
    ["Ninjaco99"] = "17397372642",
    ["GasMask"] = "9416404023",
    ["Assasin"] = "117968424",
    ...
    ["Ninja"] = "13372374109", --original: 13372374109
    ...
    ["deathcore"] = "17258275053",     -- Reemplazar con ID real en producción
    ["zzzz"] = "15483662986",  
    ["mark"] = "15273480838",
                        ...
                        for _, item in ipairs(model:GetChildren()) do
                            if item:IsA("Accessory") or item:IsA("Hat") then
                                ...
                                if handle then
                                    ...
                                    -- 1. Extraer el Attachment del accesorio
                                    local att = handle:FindFirstChildOfClass("Attachment")
                                    
                                    -- Configurar la cabeza como plan B (fallback) en caso de que no tenga Attachment
                                    local targetBodyPart = char:FindFirstChild("Head") 
                                    local targetAtt = nil
                                    
                                    -- 2. Buscar dinámicamente en QUÉ parte del cuerpo va este accesorio
                                    if att then
                                        for _, part in ipairs(char:GetChildren()) do
                                            if part:IsA("BasePart") then
                                                local foundAtt = part:FindFirstChild(att.Name)
                                                if foundAtt and foundAtt:IsA("Attachment") then
                                                    targetBodyPart = part -- Encontramos la parte correcta (ej. UpperTorso, RightArm)
                                                    targetAtt = foundAtt
                                                    break
                                                end
                                            end
                                    ...
                                    -- 3. Alinear el objeto usando la parte del cuerpo dinámica
                                    if targetBodyPart then
                                        ...
                                        -- 4. Emparentar al personaje
                                        acc.Parent = char
                                        
                                        -- 5. Soldar a la parte del cuerpo correcta (ya no solo a la cabeza)
