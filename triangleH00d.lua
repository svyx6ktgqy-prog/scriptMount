...
local StealthToggle = StealthTab:CreateToggle({
    ...
    Callback = function(Value)
        ...
        if Value then
            ...
            -- 2. FLY + NOCLIP CON FIX DE ROTACIÓN HACIA DIRECCIÓN DE MOVIMIENTO
            flyConn = RunService.RenderStepped:Connect(function()
                ...
                if hrp and hum and hum.Health > 0 then
                    ...
                    if moveDir.Magnitude > 0 then
                        ...
                        local newPos = hrp.Position + (dir * 0.35)
                        
                        -- Calculamos la rotación plana (ignorando el eje Y) para que mire hacia adelante suavemente
