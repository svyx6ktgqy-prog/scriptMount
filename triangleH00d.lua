-- ==========================================
-- Mini chit Hood Argentino V10 (VECTOR GLIDE) - iOS
-- ==========================================
...
ScreenGui.Name = "MiniChitHoodV10"
...
Title.Text = "Mini chit Hood Argentino (V10 Glide)"
...
-- Botón 1: Repartos Ya (Modo Desplazamiento Forzado)
...
BtnPlata.Text = "Repartos Ya (Glide Auto)"
...
-- ==========================================
-- 2. FUNCIONES DE CLICS Y DESPLAZAMIENTO FLUIDO
-- ==========================================
...
-- Método Glide: Arrastra al personaje paso a paso o de golpe asegurando que la física no lo reje
local function glideToTarget(targetObject)
    ...
    if targetCFrame then
        ...
        -- Si está muy lejos, hacemos una transición rápida bloqueando la gravedad momentáneamente para evitar caídas
        if distance > 15 then
            hrp.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
            -- Salto directo al destino exacto con una ligera elevación para no atravesar el suelo
        ...
        -- Forzar al Humanoid a caminar hacia el punto exacto para activar triggers de eventos
...
-- ==========================================
-- 3. BUCLE INTELIGENTE DE REPARTOS YA
-- ==========================================
                ...
                if deliveryFolder then
                    for _, loc in ipairs(deliveryFolder:GetChildren()) do
                        ...
                        if prompt and prompt.Enabled then
                            ...
                            glideToTarget(targetPart)
                            
                            local intentos = 0
                            while prompt.Enabled and intentos < 8 and getgenv().repartosActive do
