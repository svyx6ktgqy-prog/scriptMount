-- ==========================================
-- Mini chit Hood Argentino V9 (ZERO MANUAL) - iOS
-- ==========================================
...
Title.Text = "Mini chit Hood Argentino (V9 Pro)"
...
-- Botón 1: Repartos Ya Automático (Teletransporte Total a Endpoints)
...
BtnPlata.Text = "Repartos Ya (Auto Total)"
...
-- ==========================================
-- 2. FUNCIONES DE UTILIDAD Y CLICS MÓVILES
-- ==========================================
...
-- Teletransporte directo al centro exacto (sin desfases)
local function absoluteTeleport(targetObject)
    ...
    if targetCFrame then
        -- Te posiciona exactamente en el punto sin desplazamiento extra para evitar quedar lejos
        char:PivotTo(targetCFrame)
        char.HumanoidRootPart.Velocity = Vector3.new(0, 0, 0)
        
        -- Simulamos un movimiento corto para que el servidor y el anti-cheat registren la posición real
        pcall(function()
