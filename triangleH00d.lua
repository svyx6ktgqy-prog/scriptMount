...
-- + BALACLAVA MASK (FIX VISIBILIDAD) & RADIO RAINBOW TOTAL
...
-- ==========================================
-- SWITCH MÁSCARA BALACLAVA (FIX DE VISIBILIDAD)
-- ==========================================
            ...
            pcall(function()
                ...
                if maskModel then
                    ...
                    if accessory then
                        ...
                        -- Ocultar la cara original para que no se superponga
                        ...
                        -- INTEGRACIÓN CORRECTA USANDO LA FUNCIÓN OFICIAL DE ROBLOX
                        humanoid:AddAccessory(accClone)
                    end
                end
            end)
            Rayfield:Notify({Title = "Balaclava", Content = "Máscara añadida correctamente a la cabeza.", Duration = 3})
        else
...
-- ==========================================
-- SWITCH RADIO RAINBOW TOTAL (SIN PARTÍCULAS)
-- ==========================================
...
BoomboxTab:CreateToggle({
    Name = "Efecto Radio RAINBOW (Color Total)",
    CurrentValue = false,
    ...
    Callback = function(Value)
        ...
        if Value then
            -- Limpiar tablas por seguridad
            originalColors = {}
            originalMaterials = {}
            
            -- Guardar los colores y materiales originales de TODAS las partes
            ...
            -- Bucle de colores RGB aplicado a todo
            local hue = 0
            ...
            Rayfield:Notify({Title = "Rainbow Activado", Content = "Radio brillando en modo RGB.", Duration = 3})
        else
            -- Limpiar efecto
            ...
            -- Restaurar apariencia original de todas las piezas guardadas
            for part, colorOriginal in pairs(originalColors) do
