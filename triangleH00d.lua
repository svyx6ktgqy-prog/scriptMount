...
-- + EFECTO HALLOV VIP (Nombre + Verificado + Monto Robux)
-- ==========================================
...
-- ==========================================
-- FUNCIONES DE TRANSFORMACIÓN Y ROBUX (ACTUALIZADO)
-- ==========================================
...
local function CrearEfectoRobux(char)
    ...
    -- Ajustamos tamaño para las dos líneas (Nombre y Monto)
    local bb = Instance.new("BillboardGui")
    bb.Size = UDim2.new(0, 300, 0, 75) 
    ...
    -- Layout que apila verticalmente el nombre y el contador
    ...
    -- =======================================
    -- FILA 2: ÍCONO PRINCIPAL + MINI LOGO + MONTO
    -- =======================================
    local bottomRow = Instance.new("Frame")
    bottomRow.Name = "BottomRow"
    bottomRow.Size = UDim2.new(1, 0, 0, 45)
    ...
    bottomLayout.Padding = UDim.new(0, 4) -- Pegaditos entre sí

    -- 1. Ícono grande Robux original
    ...
    mainIcon.Image = "rbxassetid://11522821414"
    mainIcon.LayoutOrder = 1
    mainIcon.Parent = bottomRow

    -- 2. Mini Logo (mismo tamaño que verificado, bien pegado al principio del monto)
    ...
    miniLogo.Image = "rbxassetid://1465641822"
    ...
    countLabel.TextStrokeColor3 = Color3.fromRGB(0, 50, 0)
    ...
    countValue.Changed:Connect(function(val)
        countLabel.Text = FormatearRobux(val)
    end)
