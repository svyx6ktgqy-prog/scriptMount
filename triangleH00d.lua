-- ==========================================
-- Mini chit Hood Argentino V8 (FIX TOTAL MÓVIL) - iOS
-- ==========================================
...
Title.Text = "Mini chit Hood Argentino (V8 Pro)"
...
-- Botón 1: Repartos Ya Automático (Celular + GPS Endpoints)
...
BtnPlata.Text = "Repartos Ya (Auto GPS)"
