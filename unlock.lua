...
local function StartCloning(TargetNPC)
    ...
    if MyHum and DummyHum then
        AnimConnection = RunService.Stepped:Connect(function()
            ...
            -- para evitar que el motor de Roblox reactive la colisión en las piernas/torso.
            ...
            for _, track in pairs(playingMyTracks) do
                ...
                -- Evitamos fugas de memoria cargando solo animaciones nuevas
...
local function StopCloning()
    ...
    -- Restaurar la visibilidad original de tu personaje real
